...
XGB = MultiOutputRegressor(xgb.XGBRegressor(n_estimators=175, learning_rate=0.065, gamma = 0, subsample=0.79, colsample_bytree = 1, max_depth=7) ).fit(train_x, train_y) 
