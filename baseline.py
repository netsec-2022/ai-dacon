...
XGB = MultiOutputRegressor(xgb.XGBRegressor(objective='reg:linear', n_estimators=150, learning_rate=0.04, gamma = 0, subsample=0.77, colsample_bytree = 1, max_depth=6) ).fit(train_x, train_y) 
